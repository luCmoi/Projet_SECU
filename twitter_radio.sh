...
#gnome-terminal --tab -t "Gestionnaire" -e "bash -c \" cd ./Gestionnaire_C ;make cleanall; make; ./gestionnaireC $1 10; exec bash\""  --tab --title="Client" -e "bash -c \"cd ./Client_Java/src; javac *.java; java Client\""
