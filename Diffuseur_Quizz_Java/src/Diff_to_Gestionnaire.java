...
String adresse;
    ...
    public Diff_to_Gestionnaire(Diffuseur diff, int port_gestionnaire, String adresse_gest){
        this.diff = diff;
        this.port_gestionnaire = port_gestionnaire;
this.adresse = adresse_gest;
    }
    @Override
    public void run() {
		...
		servAddr = servAddr.substring(0, servAddr.length()-1);
            ...
            Socket sock = new Socket(adresse, port_gestionnaire);
            try {
